...
import kashyap.anurag.medicalservice.databinding.ActivityPatientRegistrationBinding;
...
public class PatientRegistrationActivity extends AppCompatActivity {
    ...
    private String name, email, phoneNo, password, cPassword, patentId;
    ...
    private void validateData() {
         ...
         patentId = binding.patientId.getText().toString().trim();
        ...
        } else if (TextUtils.isEmpty(patentId)) {
            binding.patientId.setError("Id is required");
                ...
                .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()){
                            ...
                            Toast.makeText(PatientRegistrationActivity.this, task.getException().getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    }
                })
                        ...
                        result.addOnSuccessListener(new OnSuccessListener<Uri>() {
                            ...
                            public void onSuccess(Uri uri) {
                                if (uploadTask.isSuccessful()){
                                    ...
                                    databaseReference.child(firebaseAuth.getUid())
                                            ...
                                            .addOnSuccessListener(new OnSuccessListener<Void>() {
                                                ...
                                                public void onSuccess(Void unused) {
                                                    Toast.makeText(PatientRegistrationActivity.this, "Patients Details Updated successfully!!", Toast.LENGTH_SHORT).show();
                                                    startActivity(new Intent(PatientRegistrationActivity.this, MainActivity.class));
                                                    finishAffinity();
                                                    binding.registerBtn.setVisibility(View.VISIBLE);
                                                    binding.progressBar.setVisibility(View.GONE);
                                                }
                                    ...
                                    Toast.makeText(PatientRegistrationActivity.this, "Failed", Toast.LENGTH_SHORT).show();
                                }
            ...
            new ActivityResultCallback<ActivityResult>() {
                ...
                public void onActivityResult(ActivityResult result) {
                    ...
                    if (result.getResultCode() == Activity.RESULT_OK) {
                        ...
                        Toast.makeText(PatientRegistrationActivity.this, "Cancelled", Toast.LENGTH_SHORT).show();
                    }
